...
class Cart extends CI_Controller{
	 ...
	 */
	 public function process(){
	 		...
	 		echo "<script>alert('Thanks for Shopping with SpartanSolr! We will contact you shortly on the information provided.');</script>";
	 		echo "<script>window.location = 'http://localhost:8888/solarCart/products'</script>";	
